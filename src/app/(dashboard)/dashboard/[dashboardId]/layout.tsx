        ...
        <div className={"px-4 py-2"}>
          ...
          <div className={"flex-1 overflow-y-auto px-4"}>
              <Collapsible defaultOpen>
                  <CollapsibleTrigger className={"flex w-full items-center justify-between p-2 text-sm font-medium text-muted-foreground cursor-pointer hover:text-accent-foreground"}>
                      Main
          ...
          <div className={"px-4 py-2 border border-border"}>
              <Collapsible defaultOpen>
                  <CollapsibleTrigger
                      className={"flex w-full items-center justify-between p-2 text-sm font-medium text-muted-foreground cursor-pointer hover:text-accent-foreground [$[data-state=open]>svg]:rotate-180"}>
                      Members
